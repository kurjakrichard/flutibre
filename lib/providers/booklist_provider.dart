  ...
  Future<void> insertBook(Book book) async {
    ...
    try {
      ...
      if (book.id == null) {
        ...
        // _databaseProvider.insertAuthor(const Author(name: 'Brandon Sanderson', sort: 'Sanderson, Brandon'));
        //_databaseProvider.insertBooksAuthorsLink(BooksAuthorsLink(book: 22, author: 10));
      } else {
